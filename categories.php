...
$category_index = array_search($category_id, array_column($categories, 'id')); //получаем индекс элемента массива категорий с указанным ID
...
if (!isset($category_index) || (isset($category_index) && $category_index === '') || $category_index === false) {
    ...
    $error = 'Ошибка 404';
    $error_description = 'Такой категории не существует на сайте.';
...
$category_items = get_lot_category_count($connect, $category_id, $offset); //массив с информацией о лотах с ограничением вывода на 1 страницу
