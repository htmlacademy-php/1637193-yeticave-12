    ...
    <ul class="pagination-list">
        ...
        <?php foreach ($pages as $page): ?>
            <?php if ($page !== '...'): ?>
                <li class="pagination-item <?php if ($page === $current_page): ?>pagination-item-active<?php endif; ?>">
                    <a href="/<?= $this_page; ?>?<?php if (isset($search) && $search !== ''): ?>&search=<?= htmlspecialchars($search); ?><?php endif; ?><?php if (isset($category_id) && $category_id !== ''): ?>&id=<?= $category_id; ?><?php endif; ?>&page=<?= $page; ?>"><?= $page; ?></a>
                </li>
            <?php else: ?>
        ...
        <li class="pagination-item pagination-item-next">
            <?php if ($current_page < $pages_count): ?>
                ...
                href="/<?= $this_page; ?>?<?php if (isset($search) && $search !== ''): ?>&search=<?= htmlspecialchars($search); ?><?php endif; ?><?php if (isset($category_id) && $category_id !== ''): ?>&id=<?= $category_id; ?><?php endif; ?>&page=<?= $current_page ?>">
                    Вперед</a>
            <?php endif; ?></li>
    </ul>
<?php endif; ?>
