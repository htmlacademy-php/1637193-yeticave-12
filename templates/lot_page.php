...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($lot['title'] ?? 'Без названия') ?></title>
            ...
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="../img/<?= htmlspecialchars($lot['image_url'] ?? '#') ?>" width="730" height="548" alt="<?= htmlspecialchars($lot['title'] ?? 'Без названия') ?>">
                    </div>
                    <p class="lot-item__category">Категория: <span><?= htmlspecialchars($lot['category_title'] ?? 'Без категории') ?></span></p>
                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span class="lot-item__cost"><?= htmlspecialchars(formatted_sum($lot['current_price'])) ?? 0 ?></span>
                            </div>
                            <div class="lot-item__min-cost">
                                Мин. ставка <span><?= htmlspecialchars(formatted_sum($lot['current_price']+$lot['bet_step'])) ?? 0 ?></span>
                            </div>
                        </div>
