                ...
                <?php foreach ($ad_information as $ad_value): ?>
                    <li class="lots__item lot">
                        <div class="lot__image">
                            <img src="<?=$ad_value['url_image']; ?>" width="350" height="260" alt="<?=$ad_value['title']; ?>">
                        </div>
                        <div class="lot__info">
                            <span class="lot__category"><?=$ad_value['category'];?></span>
                            <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ad_value['title'];?></a></h3>
