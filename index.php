...
<div class="page-wrapper">
    ...
    <main class="container">
        ...
        <section class="lots">
            ...
            <ul class="lots__list">
                <!--заполнил этот список из массива $ad_information с товарами-->
                <?php foreach ($ad_information as $key => $value): ?>
                    <li class="lots__item lot">
                        <div class="lot__image">
                            <img src="<?=$value['url_image']; ?>" width="350" height="260" alt="<?=$value['title']; ?>">
                        </div>
                        <div class="lot__info">
